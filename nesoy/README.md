...
- Object 스터디 준비하기
- SNAK 관련 조사
    - REST API 보안 인증 관련 공부하기
- WWL 추가 관련 조사
    - OOP 4대 원칙 개념 / 관계 / 역할 정리해보기
...
- ~~블로그 & 블로그~~
- ~~스프링 스터디 자료 준비하기~~
- ~~Snack 개발하기~~ -> 인터뷰 / 추석연휴 등등 ㅠㅠ 우선순위 밀림

## 2019-09-08
- ~~Spring Study 자료 정리하기~~
- 우아한 멀티모듈 블로그 작성하기
    - ㅠㅠ 계속 딜레이되는 이슈..
    - 추석때 하고 싶은 공부 & 한방에 정리하자
- Snack - issue 해결하기
- ~~발표준비하기~~
...
## 2019-08-25
- 블로그 쓰기
    - <https://nesoy.github.io/articles/2019-08/logrotate>
- [Intellij 관련 내용 정리하기](https://nesoy.github.io/articles/2019-08/Intellij-Setting-Sync)

## 2019-08-18
- ~~Snack https 적용하기~~
- Snack 프로젝트 관련해서 배운 점 정리하기
    - Nginx

## 2019-08-11
- ~~Snack DNS / HTTPS 연결하기~~
...
## 2019-06-30
- [Snack CI/ CD 구축하기](https://github.com/snack-news/Snack-BE/issues/19)
...
- [토비의 Spring](http://www.aladin.co.kr/shop/wproduct.aspx?ItemId=19505561)
    - [Chapter 5 : 서비스 추상화](/nesoy/Spring/Chapter-5.md)
        - ~~5.4 메일 서비스 추상화~~
        - ~~5.5 정리~~
    - [Chapter 6 : AOP](/nesoy/Spring/Chapter-6.md)
        - ~~6.1 트랜잭션 코드의 분리~~
        - ~~6.2 고립된 단위 테스트~~
        - 6.3 다이내믹 프록시와 팩토리 빈
...
- Book
    - [실용주의 프로그래머](/nesoy/Book/PragmaticProgrammer.md)
        - ~ 27 메타 프로그래밍
- [Algorithm](http://www.aladin.co.kr/shop/wproduct.aspx?ItemId=43636357&start=slayer)
    - 함수의 증가
    - 분할정복
    - 확률적 분석과 랜덤화된 알고리즘
    - 힙 정렬
